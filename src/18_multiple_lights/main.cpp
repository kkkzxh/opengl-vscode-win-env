...
int main()
{
	...
	// 绘制物体的着色器
	Shader ourShader("./src/18_multiple_lights/vs.glsl", "./src/18_multiple_lights/fs.glsl");

	// 绘制光源的着色器
	Shader lampShader("./src/18_multiple_lights/lightCube_vs.glsl", "./src/18_multiple_lights/lightCube_fs.glsl");
