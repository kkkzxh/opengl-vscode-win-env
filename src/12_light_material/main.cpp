...
int main()
{
	...
	// 绘制物体的着色器
	Shader ourShader("./src/12_light_material/vs.glsl", "./src/12_light_material/fs.glsl");

	// 绘制光源的着色器
	Shader lampShader("./src/12_light_material/lightCube_vs.glsl", "./src/12_light_material/lightCube_fs.glsl");
