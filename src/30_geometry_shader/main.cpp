...
int main()
{
	...
	Shader screenShader("./src/30_geometry_shader/framebuffer_vert.glsl", "./src/30_geometry_shader/framebuffer_frag.glsl");
	Shader skyboxShader("./src/30_geometry_shader/skybox_vert.glsl", "./src/30_geometry_shader/skybox_frag.glsl");
	Shader pointsShader("./src/30_geometry_shader/points_vert.glsl", "./src/30_geometry_shader/points_frag.glsl", "./src/30_geometry_shader/points_gemo.glsl");
