...
int main()
{
	...
	// 绘制物体的着色器
	Shader shader("./src/24_face_culling/blending_vs.glsl", "./src/24_face_culling/blending_fs.glsl");
	Shader screenShader("./src/24_face_culling/framebuffer_vert.glsl", "./src/24_face_culling/framebuffer_frag.glsl");
