...
int main()
{
	...
	Shader screenShader("./src/37_point_shadows/shader/framebuffer_vert.glsl", "./src/37_point_shadows/shader/framebuffer_frag.glsl");
	Shader cubeShader("./src/37_point_shadows/shader/cube_vert.glsl", "./src/37_point_shadows/shader/cube_frag.glsl");
	Shader planeShader("./src/37_point_shadows/shader/plane_vert.glsl", "./src/37_point_shadows/shader/plane_frag.glsl");

	Shader simpleDepthShader("./src/37_point_shadows/shader/shadow_mapping_depth_vert.glsl", "./src/37_point_shadows/shader/shadow_mapping_depth_frag.glsl", "./src/37_point_shadows/shader/shadow_mapping_depth_geom.glsl");
	Shader debugDepthQuad("./src/37_point_shadows/shader/debug_quad_vert.glsl", "./src/37_point_shadows/shader/debug_quad_frag.glsl");
	Shader shader("./src/37_point_shadows/shader/shadow_mapping_vert.glsl", "./src/37_point_shadows/shader/shadow_mapping_frag.glsl");
