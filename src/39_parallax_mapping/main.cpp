...
int main()
{
	...
	Shader screenShader("./src/39_parallax_mapping/shader/framebuffer_vert.glsl", "./src/39_parallax_mapping/shader/framebuffer_frag.glsl");

	// 直接使用法线贴图进行光照计算
	Shader planeShader("./src/39_parallax_mapping/shader/normal_mapping_vert.glsl", "./src/39_parallax_mapping/shader/normal_mapping_frag.glsl");

	// 使用转换到切线空间的TBN法线贴图
	Shader cubeShader("./src/39_parallax_mapping/shader/tangent_height_mapping_vert.glsl", "./src/39_parallax_mapping/shader/tangent_height_mapping_frag.glsl");
	...
	// 地面
	//unsigned int diffauseMap = loadTexture("./static/texture/TexturesCom_MuddySand2_2x2_2K_albedo.png");
	//unsigned int normalMap = loadTexture("./static/texture/TexturesCom_MuddySand2_2x2_2K_normal.png");
	//unsigned int heightMap = loadTexture("./static/texture/TexturesCom_MuddySand2_2x2_2K_height.png");

	// 木制
	//unsigned int diffauseMap = loadTexture("./static/texture/wood.png");
	//unsigned int normalMap = loadTexture("./static/texture/toy_box_normal.png");
	//unsigned int heightMap = loadTexture("./static/texture/toy_box_disp.png");
