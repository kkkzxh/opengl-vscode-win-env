...
int main()
{
	...
	// 绘制物体的着色器
	Shader ourShader("./src/17_spot_light/vs.glsl", "./src/17_spot_light/fs.glsl");

	// 绘制光源的着色器
	Shader lampShader("./src/17_spot_light/lightCube_vs.glsl", "./src/17_spot_light/lightCube_fs.glsl");
