...
int main()
{
	...
	// 绘制物体的着色器
	Shader shader("./src/25_framebuffers/blending_vs.glsl", "./src/25_framebuffers/blending_fs.glsl");
	Shader screenShader("./src/25_framebuffers/framebuffer_vert.glsl", "./src/25_framebuffers/framebuffer_frag.glsl");
