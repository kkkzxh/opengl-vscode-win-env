...
int main()
{
	...
	// 绘制物体的着色器
	Shader ourShader("./src/13_material_practice/vs.glsl", "./src/13_material_practice/fs.glsl");

	// 绘制光源的着色器
	Shader lampShader("./src/13_material_practice/lightCube_vs.glsl", "./src/13_material_practice/lightCube_fs.glsl");
