...
int main()
{
	...
	// 绘制物体的着色器
	Shader ourShader("./src/14_light_map/vs.glsl", "./src/14_light_map/fs.glsl");

	// 绘制光源的着色器
	Shader lampShader("./src/14_light_map/lightCube_vs.glsl", "./src/14_light_map/lightCube_fs.glsl");
	...
	unsigned int creativesamMap = loadTexture("./static/texture/matrix.jpg");
