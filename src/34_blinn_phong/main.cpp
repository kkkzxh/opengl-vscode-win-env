...
int main()
{
	...
	Shader screenShader("./src/34_blinn_phong/framebuffer_vert.glsl", "./src/34_blinn_phong/framebuffer_frag.glsl");
	Shader cubeShader("./src/34_blinn_phong/cube_vert.glsl", "./src/34_blinn_phong/cube_frag.glsl");
	Shader planeShader("./src/34_blinn_phong/plane_vert.glsl", "./src/34_blinn_phong/plane_frag.glsl");
